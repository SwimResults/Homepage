...
<div class="container">
    ...
    <div class="markdown">
        ...
        <h1>Kontakt</h1>
        <p>Konrad</p>
        <p>E-Mail: kontakt@swimresults.de</p>
        <p><a href="https://github.com/sponsors/konrad2002"><img src="https://img.shields.io/static/v1?label=Sponsor&amp;message=%E2%9D%A4&amp;logo=GitHub&amp;color=%23fe8e86" alt=""></a></p>
        <h1>Status</h1>
        <p>Den aktuellen Stand der Entwicklung findet man unter <a href="https://status.swimresults.de/">status.swimresults.de</a>.</p>
        <blockquote>
